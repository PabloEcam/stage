...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/Room-04.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="Taburetes1001" position={[-4.408, 0.455, 0.55]} scale={0.025}>
        ...
        <mesh name="RelojPendulo" castShadow receiveShadow geometry={nodes.RelojPendulo.geometry} material={materials['color-03']} position={[-0.172, 1.111, -1.929]} rotation={[Math.PI / 2, -0.436, 0]} scale={[0.025, 0.005, 0.025]} />
        <mesh name="Poster" castShadow receiveShadow geometry={nodes.Poster.geometry} material={materials['mario poster']} position={[0.955, 1.453, -1.965]} rotation={[Math.PI / 2, 0, 0]} scale={[0.022, 0.004, 0.022]} />
        <group name="MarioCarton" position={[-2.011, 1.157, 0.334]} rotation={[Math.PI / 2, 0, 0.001]} scale={[0.063, 0.02, 0.063]}>
        ...
        <mesh name="MarioAlpha" castShadow receiveShadow geometry={nodes.MarioAlpha.geometry} material={materials['mario alpha']} position={[-5.7, 1.026, 1.702]} rotation={[Math.PI / 2, 0, 0]} scale={[0.02, 0.019, 0.02]} />
        <mesh name="Estrella" castShadow receiveShadow geometry={nodes.Estrella.geometry} material={materials['estrella alpha']} position={[-4.416, 1.138, 0.517]} rotation={[Math.PI / 2, 0, 0]} scale={[0.007, 0.025, 0.007]} />
        ...
        <mesh name="RelojManilla1" castShadow receiveShadow geometry={nodes.RelojManilla1.geometry} material={materials['color-03']} position={[0.086, 1.814, -1.9]} rotation={[Math.PI / 2, 0, 0]} scale={0.025} />
        <mesh name="RelojManilla2" castShadow receiveShadow geometry={nodes.RelojManilla2.geometry} material={materials['color-03']} position={[0.086, 1.814, -1.887]} rotation={[Math.PI / 2, 0, 0]} scale={0.025} />
        <mesh name="EspejoMarco" castShadow receiveShadow geometry={nodes.EspejoMarco.geometry} material={materials['color-01']} position={[-3.369, 1.389, -1.98]} rotation={[-Math.PI / 2, 0, 0]} scale={[-0.032, -0.009, -0.032]} />
        <mesh name="Espejo" castShadow receiveShadow geometry={nodes.Espejo.geometry} material={materials.espejo} position={[-3.37, 1.389, -1.959]} rotation={[Math.PI / 2, 0, 0]} scale={0.025} />
        <mesh name="Saturno" castShadow receiveShadow geometry={nodes.Saturno.geometry} material={materials['metal-1']} position={[0.231, 1.036, 0.39]} scale={0.034} />
        <mesh name="SaturnoAro" castShadow receiveShadow geometry={nodes.SaturnoAro.geometry} material={materials['metal-1']} position={[0.226, 1.027, 0.392]} rotation={[0, 0, Math.PI / 9]} scale={[0.025, 0.02, 0.012]} />
        ...
        <mesh name="MaquinaJuegos-pantalla" castShadow receiveShadow geometry={nodes['MaquinaJuegos-pantalla'].geometry} material={materials['pantalla game']} position={[-5.432, 1.301, -1.257]} rotation={[1.313, 0, 0]} scale={[0.021, 0.025, 0.022]} />
        <group name="MaquinaJuegos" position={[-4.931, 1.08, -1.261]} rotation={[Math.PI / 2, 0, Math.PI / 2]} scale={0.025}>
          <mesh name="Malla039" castShadow receiveShadow geometry={nodes.Malla039.geometry} material={materials['metal-1']} />
          <mesh name="Malla039_1" castShadow receiveShadow geometry={nodes.Malla039_1.geometry} material={materials['color-01.001']} />
          <mesh name="Malla039_2" castShadow receiveShadow geometry={nodes.Malla039_2.geometry} material={materials['color-00.001']} />
          <mesh name="Malla039_3" castShadow receiveShadow geometry={nodes.Malla039_3.geometry} material={materials['color-08']} />
          <mesh name="Malla039_4" castShadow receiveShadow geometry={nodes.Malla039_4.geometry} material={materials['color-03']} />
          <mesh name="Malla039_5" castShadow receiveShadow geometry={nodes.Malla039_5.geometry} material={materials['metal-1.001']} />
          <mesh name="Malla039_6" castShadow receiveShadow geometry={nodes.Malla039_6.geometry} material={materials['color negro']} />
          <mesh name="Malla039_7" castShadow receiveShadow geometry={nodes.Malla039_7.geometry} material={materials['color-04.001']} />
        </group>
      </group>
    </group>
  )
