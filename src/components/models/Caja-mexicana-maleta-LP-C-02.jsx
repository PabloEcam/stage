...
Command: npx gltfjsx@6.2.13 ./public/models/Caja-mexicana-maleta-LP-C-02.glb 
*/
...
export default function Model(props) {
  ...
  const { nodes, materials, animations } = useGLTF(
    './models/Caja-mexicana-maleta-LP-C-02.glb'
  )
...
useGLTF.preload('./models/Caja-mexicana-maleta-LP-C-02.glb')
